  ...
  return (
    ...
    >
      <div className="md:w-2/3 lg:w-1/2 container px-5 md:px-16 mx-auto">
        <h1 className="capitalize text-3xl sm:text-4xl md:text-[3.2rem] 2xl:text-6xl font-bold">
          <p>Welcome to UEM Kolkata's Official IKS Website.</p>
        </h1>
        <p className="text-lg leading-normal sm:leading-loose my-4 md:my-6">
          Explore our Industry leading professors and instructor, who are
          shaping the technical education more preciesely for generation ahead.
        </p>
